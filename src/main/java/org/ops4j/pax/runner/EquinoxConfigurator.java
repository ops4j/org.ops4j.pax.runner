...
//                + file.getAbsolutePath());
     ...
     * @throws IOException
     */
    private boolean load(InputStream in) throws IOException
    {
...
class GroupArtifactVersion
{
    ...
    public GroupArtifactVersion(String groupId, String artifactId,
            String version)
    {
        super();
    ...
    public boolean equals(Object o)
    {
        ...
        {
            return ( (GroupArtifactVersion) o ).toString().equals(toString());
        }
        return false;
    }
