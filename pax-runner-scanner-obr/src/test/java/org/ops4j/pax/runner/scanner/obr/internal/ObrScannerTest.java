...
public class ObrScannerTest
{
    ...
    {
        new ObrScanner( createMock( PropertyResolver.class ) ).scan( null );
    }
    ...
    public void scanWithEmptyURLSpec()
        throws ScannerException, MalformedSpecificationException
    {
        new ObrScanner( createMock( PropertyResolver.class ) ).scan( " " );
    }
    ...
    private ObrScanner createFileScanner( final ScannerConfiguration config, final Parser parser )
    {
        return new ObrScanner( createMock( PropertyResolver.class ) )
        {
            @Override
