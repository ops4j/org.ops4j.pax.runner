...
public class FileUtils
{
    ...
    public static Writer openPropertyFile( File file )
        throws IOException
    {
    ...
    public static void writeProperty( Writer out, String key, String value )
        throws IOException
    {
        out.write( key );
        out.write( '=' );
    ...
    public static String getTextContent( File textUtf8File )
        throws IOException
    {
