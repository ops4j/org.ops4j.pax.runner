package org.ops4j.pixea.runner.forms;/*
...
import org.ops4j.pixea.runner.editor.RepositoryNodeFactory;
import org.ops4j.pixea.runner.repositories.BundleRef;
import org.ops4j.pixea.runner.repositories.RepositoryInfo;
import org.ops4j.pixea.runner.repositories.RepositoryObserver;
    ...
    implements RepositoryObserver
{
     ...
     * @param config The configuration bean representing current Runner config.
     */
