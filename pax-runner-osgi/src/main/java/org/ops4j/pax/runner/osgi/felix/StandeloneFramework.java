...
public class StandeloneFramework implements Framework, CreateActivator
{
   ...
   public Context getContext() {
    ...
    protected Context createContext(  )
    {
        ...
        final ServiceRegistry serviceRegistry = new ServiceRegistry( logger2, new ServiceRegistryCallbacks(){
			...
			public void serviceChanged(ServiceEvent event, Dictionary oldProps) {
				...
				dispatcher.fireServiceEvent( event, oldProps, StandeloneFramework.this );
			}} );
    ...
    private static void createLogger( final LogLevel logLevel )
    {
        try
        {
            LOGGER = LogFactory.getLog( StandeloneFramework.class, logLevel );
        }
	...
	public Version getVersion() {
		return _context0.getBundle().getVersion();
	}
